...
About the Direct reduction model
	...
	MATLAB Script: SS_solve.m
		...
		of iterations. When the zero solution is found, the script prints a table showing the outlet conditions as well 
		as giving the option for the user to print figures for temperature, concentration, and metallization profiles by 
